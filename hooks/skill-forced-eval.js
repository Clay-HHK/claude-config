...
const KEYWORD_SKILL_MAP = [
  ...
  { keywords: /\b(experiment|tmux|sweep|running|monitor|progress|gpu)\b|实验|跑|进度|监控/i, skills: ['check-experiments'] },
  { keywords: /\b(edit.*paper|paper.*edit|polish|revise|shorten.*paper|em.?dash|caption)\b|改论文|润色|缩短|修改论文/i, skills: ['paper-edit'] },
];
